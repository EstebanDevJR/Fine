...
def configure_bucket_cors(settings: Settings, bucket: str, allowed_origins: list[str] | None = None) -> None:
    """
    ...
    try:
        ...
        if error_code == "NoSuchBucket":
            ...
            raise PermissionError(f"Access denied. Check AWS credentials and bucket permissions.")
        else:
